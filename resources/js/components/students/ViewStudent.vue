    ...
    <div class="row mb-4">
        <div class="col-md-5">
            <div class="card bg-dark text-white">
                <div class="card-header"><h1>{{student.name}}</h1></div>
                <div class="card-body">
                    <div class="float-right mb-2">
                        <router-link :to="{ name: 'students.edit', params: { id: student.id } }" class="btn btn-primary">Edit</router-link>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr :key="enrolment.date" v-for="enrolment in student.enrolments">
                                <th scope="row"><router-link :to="{ name: 'courses.view', params: { id: enrolment.course.id } }">{{enrolment.course.title}}</router-link></th>
...
<script>
    export default {
        ...
        data: function () {
            return {
                // object has two properties; student & errors - automatic two-way binding
                student: {
                    name: '',
                    email: '',
                    phone: '',
